...
class CalculatorApp(ft.Container):
            ...
            controls=[
                ...
                ft.Row(
                    controls=[
                        ...
                        ScientificButton(text="x*x", button_clicked=self.button_clicked),
                        ScientificButton(text="√", button_clicked=self.button_clicked),  # 追加
                    ]
                ),
            ]
        )
    ...
    def button_clicked(self, e):
        ...
        elif data in ("sin", "cos", "tan", "exp", "log", "x*x", "√"):
